...
class Accounts
{
  public:
    struct Cols
    {
        ...
        static const std::string _account_creation_date;
    ...
    /**  For column account_creation_date  */
    ///Get the value of the column account_creation_date, returns the default value if the column is null
    const ::trantor::Date &getValueOfAccountCreationDate() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<::trantor::Date> &getAccountCreationDate() const noexcept;
    ///Set the value of the column account_creation_date
    void setAccountCreationDate(const ::trantor::Date &pAccountCreationDate) noexcept;
    void setAccountCreationDateToNull() noexcept;
    ...
    Admins getAccount(const drogon::orm::DbClientPtr &clientPtr) const;
  ...
  private:
    ...
    std::shared_ptr<::trantor::Date> accountCreationDate_;
