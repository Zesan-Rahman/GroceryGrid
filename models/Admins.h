...
class Admins
{
  public:
    ...
    std::vector<std::pair<Reports,AdminReports>> getReports(const drogon::orm::DbClientPtr &clientPtr) const;
    void getReports(const drogon::orm::DbClientPtr &clientPtr,
