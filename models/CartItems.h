...
class CartItems
{
  public:
     ...
     */
    explicit CartItems(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit CartItems(const Json::Value &pJson) noexcept(false);
     ...
     */
    CartItems(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<CartItems>;
    friend drogon::orm::BaseBuilder<CartItems, true, true>;
    friend drogon::orm::BaseBuilder<CartItems, true, false>;
    friend drogon::orm::BaseBuilder<CartItems, false, true>;
    friend drogon::orm::BaseBuilder<CartItems, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<CartItems>;
#endif
